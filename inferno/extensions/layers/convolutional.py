...
__all__ = ['ConvActivation',
           ...
           'ValidConvELU', 'ValidConvELU1D', 'ValidConvELU2D', 'ValidConvELU3D',
...
class ValidConvELU(ConvActivation):
    """ND Convolutional layer with 'VALID' padding, ELU and orthogonal weight initialization."""
    def __init__(self, dim, in_channels, out_channels, kernel_size):
        super(ValidConvELU, self).__init__(in_channels=in_channels,
                                        out_channels=out_channels,
                                        kernel_size=kernel_size,
                                        dim=1,
                                        activation='ELU',
...
class ValidConvELU1D(ConvActivation):
    """2D Convolutional layer with 'VALID' padding, ELU and orthogonal weight initialization."""
    def __init__(self, in_channels, out_channels, kernel_size):
        super(ValidConvELU1D, self).__init__(in_channels=in_channels,
                                        out_channels=out_channels,
                                        kernel_size=kernel_size,
                                        dim=1,
                                        activation='ELU',
